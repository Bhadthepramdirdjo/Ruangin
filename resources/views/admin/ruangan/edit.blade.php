            ...
            <form action="{{ route('admin.ruangan.update', $ruangan->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="nama_ruangan" 
                        class="form-control"
                        value="{{ old('nama_ruangan', $ruangan->nama_ruang) }}"
                        required
                    >
                    @error('nama_ruangan')
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        name="kode" 
                        class="form-control"
                        value="{{ old('kode', $ruangan->kode_ruang) }}"
                        required
                    >
                    @error('kode')
                        <div class="form-error">{{ $message }}</div>
                ...
                <div class="form-group">
                    ...
                    <select id="tipe" name="tipe" class="form-control" required>
                        <option value="kelas" {{ old('tipe', $ruangan->tipe) === 'kelas' ? 'selected' : '' }}>Kelas</option>
                        <option value="laboratorium" {{ old('tipe', $ruangan->tipe) === 'laboratorium' ? 'selected' : '' }}>Laboratorium</option>
                        <option value="seminar" {{ old('tipe', $ruangan->tipe) === 'seminar' ? 'selected' : '' }}>Ruang Seminar</option>
                        <option value="meeting" {{ old('tipe', $ruangan->tipe) === 'meeting' ? 'selected' : '' }}>Meeting Room</option>
                    </select>
                    @error('tipe')
                        <div class="form-error">{{ $message }}</div>
                    @enderror
                ...
                <button type="submit" class="btn">✓ Update Ruangan</button>
            </form>
        </div>
    </div>
</div>
